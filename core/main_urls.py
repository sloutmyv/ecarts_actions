...
# path('services/<int:pk>/toggle-active/', views.service_toggle_active, name='service_toggle_active'),  # Supprimé - gestion via admin Django uniquement
...
# path('users/<int:pk>/toggle-active/', views.user_toggle_active, name='user_toggle_active'),  # Supprimé - gestion via admin Django uniquement
